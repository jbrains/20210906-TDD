...
public class ConsumeAndDispatchCommandsTest {
    private final PointOfSaleTerminal pointOfSaleTerminal = new PointOfSaleTerminal();

    @Test
    void oneCommand() throws Exception {
        CommandInterpreter commandInterpreter = Mockito.mock(CommandInterpreter.class);

        pointOfSaleTerminal.runTerminal(new StringReader("::command 1::"), commandInterpreter, new TrimWhitespace()::canonicalizeCommand);
    ...
    void noCommands() throws Exception {
        ...
        pointOfSaleTerminal.runTerminal(new StringReader(""), commandInterpreter, new TrimWhitespace()::canonicalizeCommand);
    ...
    void severalCommands() throws Exception {
        ...
        pointOfSaleTerminal.runTerminal(new StringReader("::command 1::\n::command 2::\n::command 3::"), commandInterpreter, new TrimWhitespace()::canonicalizeCommand);
    ...
    void canonicalizeCommands() {
        ...
        Stream<String> canonicalCommands = lines.stream().map(new TrimWhitespace()::canonicalizeCommand);
